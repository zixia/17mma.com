...
//Ucenter Home配置参数
$_SC = array();
$_SC['dbhost']  		= getenv('MMA17_MYSQL_HOST'); //服务器地址
$_SC['dbuser']  		= getenv('MMA17_MYSQL_USER'); //用户
$_SC['dbpw'] 	 		= getenv('MMA17_MYSQL_PASS'); //密码
$_SC['dbname']  		= '17mma'; //数据库
...
define('UC_DBHOST', getenv('MMA17_MYSQL_HOST')); // UCenter 数据库主机
define('UC_DBUSER', getenv('MMA17_MYSQL_USER')); // UCenter 数据库用户名
define('UC_DBPW', getenv('MMA17_MYSQL_PASS')); // UCenter 数据库密码
define('UC_DBNAME', '17mma'); // UCenter 数据库名称

define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`17mma`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', '65n145h5Afi703U4i8W88frbUdV8B4Seq8X5gaE1x1T425JdKbzfN1q2c2tbFdid'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'https://17mma.zixia.net/center'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
